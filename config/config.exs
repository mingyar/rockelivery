...
config :rockelivery, RockeliveryWeb.Auth.Guardian,
  issuer: "rockelivery",
  secret_key: "GWob50yFNq0clgggY4QdB/KRuV+Xv+KTWTCCjDNY5IRe9z1CaWibHwuW/GB2yBm"
...
config :rockelivery, RockeliveryWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "ZmRryn1Jp7cjSLrkoJygl+M7hk1A1b0eNICbBirt9xJ8xpBVe+/mfTV/hflpew+V",
  render_errors: [view: RockeliveryWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Rockelivery.PubSub,
  live_view: [signing_salt: "YzsAFlV5"]
